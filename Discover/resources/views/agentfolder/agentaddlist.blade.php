...
<!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
    <div class="page-breadcrumb" style="bacround: #00ffff;">
        <div class="row">kg
            <div class="col-5 align-self-center">
                <h4 class="page-title text-primary">Add Property List</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <div class="row justify-content-md-center" style="background: #00ffff;">
            <div class="col-12" >
                ...
                @endif
                    <form action="{{ url('store') }}" method="POST" class="form-horizontal m-t-30" enctype="multipart/form-data"> 
                        @csrf
