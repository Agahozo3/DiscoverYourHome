...
<section id="showcase-inner" class="py-5 text-white" style="margin-top: -40px;">
        ...
        <img src="{{ asset('assets/img/ama.png') }}" class="logo" alt="">
            ...
            <h1 class="display-4">DISCOVER YOUR HOME</h1>
  ...
  <section id="team" class="py-5" style="background: rgba(0, 0, 0, 0.1);">
    ...
    <section id="about" class="py-4">
        ...
        <div class="row">
            ...
            <p class="lead text-center">DISCOVER YOUR HOME  Real Estate shall be the preferred developer for the first time Filipino <br>homebuyer who seeks to live in a nurturing community.</p>
            <h2 class="text-success" style="margin-left: 36%;">Subdivision Map</h2>
            <img src="assets/img/map.jpg" alt="" style="width: 100%;">
            <p class="mt-4 text-center">DISCOVER YOUR HOME has always been true to its core ideals and is in constant collaboration with its affiliates to provide and share best practices as we are deeply committed to improving the lives of the communities we serve.</p>
            <h2 class="text-center">Memories for a Lifetime.</h2>
            <p class="lead text-center">Achieve your DREAM HOME here DISCOVER YOUR HOME Real estate, and we give you the perfect setting to create memories for a lifetime.</p>
